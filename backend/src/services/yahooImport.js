...
const NFL_GAME_KEYS = {
  2001: '57',  2002: '49',  2003: '79',  2004: '101',
  2005: '124', 2006: '153', 2007: '175', 2008: '199',
  2009: '222', 2010: '242', 2011: '257', 2012: '273',
  2013: '314', 2014: '331',
...
async function runFullImport(yahooLeagueId, userId, db, accessToken, targetLeagueId, selectedSeasons, onTokenRefresh) {
  ...
  try {
    ...
    if (mostRecentSeason) {
      detectedSettings = settingsMapper.mapSettingsForPlatform('yahoo', mostRecentSeason)

      if (!targetLeagueId && detectedSettings) {
        try {
          const updateData = { settings: { ...(clutchLeague.settings || {}), ...detectedSettings.settings, importedFrom: 'yahoo' } }
