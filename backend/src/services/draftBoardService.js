...
function enrichPlayer(player, sport, extras = {}) {
  ...
  return {
    ...
    sgOffTee: player.sgOffTee ?? null,
    sgApproach: player.sgApproach ?? null,
    sgPutting: player.sgPutting ?? null,
    sgAroundGreen: player.sgAroundGreen ?? null,
    sgTeeToGreen: player.sgTeeToGreen ?? null,
    fedexRank: player.fedexRank,
    primaryTour: player.primaryTour ?? null,
    country: player.country ?? null,
    countryFlag: player.countryFlag ?? null,
    wins: player.wins ?? 0,
    top10s: player.top10s ?? 0,
