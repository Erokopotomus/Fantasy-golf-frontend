...
/**
 * CHARACTERISTIC_META — display metadata for each of the 19 manager intelligence
 * characteristics. Used by the admin UI (Library/Detail/User Profile pages) to
 * render names, descriptions, and category grouping. Update this when adding
 * new extractors.
 */
