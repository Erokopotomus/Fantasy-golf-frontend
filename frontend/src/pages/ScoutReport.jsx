  ...
  if (error || !report) {
    return (
      <div className="max-w-3xl mx-auto px-4 py-8 text-center">
        ...
        <p className="text-text-primary/50 mb-4">{error || 'No scout report available'}</p>
    ...
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h1 className="text-2xl font-bold font-display text-text-primary">{report.title || 'Scout Report'}</h1>
