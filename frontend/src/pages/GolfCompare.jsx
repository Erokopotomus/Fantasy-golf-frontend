              ...
              <div className="flex flex-wrap gap-2 mt-3">
                {players.map((p, pi) => (
                  ...
                  >
                    ...
                    <button onClick={() => removePlayer(p.id)} className="text-text-muted hover:text-red-400 transition-colors ml-0.5">
                    ...
                    >
                      ...
                      <div className="mt-2 space-y-1.5">
                        <div className="flex items-center justify-between">
                          ...
                          <span className={`text-xs font-mono font-bold ${(p.cpi || 0) >= 0 ? 'text-emerald-400' : 'text-red-400'}`}>
