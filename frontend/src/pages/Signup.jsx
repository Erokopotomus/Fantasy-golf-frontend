          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-dark-primary text-text-muted">Or sign up with</span>
              </div>
            </div>

            <div className="mt-6 grid grid-cols-2 gap-4">
              <button className="flex items-center justify-center gap-2 px-4 py-3 bg-dark-secondary border border-dark-border rounded-lg hover:bg-dark-tertiary hover:shadow-card transition-all duration-300 active:scale-[0.98]">
                ...
                <span className="text-text-secondary text-sm font-medium">Google</span>
              </button>
              <button className="flex items-center justify-center gap-2 px-4 py-3 bg-dark-secondary border border-dark-border rounded-lg hover:bg-dark-tertiary hover:shadow-card transition-all duration-300 active:scale-[0.98]">
                ...
                <span className="text-text-secondary text-sm font-medium">GitHub</span>
              </button>
            </div>
          </div>
