          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              ...
              >
                ...
                <span className="text-text-muted text-sm font-medium">Google <span className="text-[10px]">(soon)</span></span>
              </button>
              <button
                type="button"
                disabled
              ...
              >
                ...
                <span className="text-text-muted text-sm font-medium">GitHub <span className="text-[10px]">(soon)</span></span>
              </button>
            </div>
          </div>
