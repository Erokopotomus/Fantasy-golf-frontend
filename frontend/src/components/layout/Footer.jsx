        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <button onClick={() => scrollToSection('features')} className="text-text-secondary hover:text-text-primary text-sm transition-colors">
                  Features
                </button>
              </li>
              <li>
                <button onClick={() => scrollToSection('how-it-works')} className="text-text-secondary hover:text-text-primary text-sm transition-colors">
                  How It Works
                </button>
              </li>
            </ul>
          ...
          {/* Get Started */}
          <div>
            <h4 className="text-text-primary font-semibold mb-4">Get Started</h4>
            <ul className="space-y-2">
              <li>
