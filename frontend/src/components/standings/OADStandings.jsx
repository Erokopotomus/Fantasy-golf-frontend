...
const OADStandings = ({ standings, currentUserId }) => {
  ...
  return (
    <Card>
      <h3 className="text-lg font-semibold font-display text-text-primary mb-4">One & Done Standings</h3>
          ...
          return (
            ...
            >
              ...
              <div className="text-right">
                <p className="text-2xl font-bold font-display text-gold">{team.points}</p>
      ...
      {/* Legend */}
      <div className="mt-4 pt-4 border-t border-[var(--card-border)] text-xs text-text-muted">
