  ...
  return (
    <Card>
      <div className="flex items-center justify-between mb-4">
        ...
        {isLocked && (
          <span className="px-3 py-1 bg-live-red/20 text-live-red rounded-lg text-sm">
            Lineup Locked
          </span>
        )}
      </div>
      ...
      {isLocked ? (
        <div className="text-center py-6 bg-[var(--card-bg)] rounded-lg">
                ...
                <button
                  ...
                  className={`
                    ...
                    ${isSelected
                      ...
                      : isDisabled
                        ? 'bg-[var(--card-bg)] opacity-50 cursor-not-allowed'
                        : 'bg-[var(--card-bg)] border-2 border-transparent hover:border-text-muted'
                    }
                  `}
                >
