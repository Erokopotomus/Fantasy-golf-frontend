...
const ChatPanel = ({
  ...
  return (
    <div className={`flex flex-col bg-dark-secondary border border-dark-border rounded-xl overflow-hidden ${className}`}>
      {/* Header */}
      <div className="flex items-center justify-between px-4 py-3 border-b border-dark-border bg-dark-tertiary/30">
        <div className="flex items-center gap-3">
      ...
      <div
        ...
        className="flex-1 overflow-y-auto p-4 space-y-1 min-h-[300px] max-h-[500px] scrollbar-thin"
      >
        {loading ? (
