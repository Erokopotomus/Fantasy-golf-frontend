...
const CoachBriefing = ({ feedCards = [], feedLoading = false }) => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
      ...
      <div className={`relative overflow-hidden rounded-xl border border-purple-500/20 bg-gradient-to-br from-purple-500/[0.07] via-[var(--surface)] to-[var(--surface)] p-5 ${hasFeed ? 'lg:col-span-2' : 'lg:col-span-3'}`}>
        {/* Background sphere */}
      ...
      {hasFeed && (
        <div className="rounded-xl border border-[var(--card-border)] bg-[var(--surface)] p-4 lg:col-span-1">
          <div className="flex items-center justify-between mb-3">
