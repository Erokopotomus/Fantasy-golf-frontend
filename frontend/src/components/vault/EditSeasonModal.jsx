    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4" onClick={onClose}>
      ...
      >
        ...
        <div className="p-5 overflow-y-auto flex-1">
              ...
              return (
                <div
                  ...
                  className={`flex items-center gap-2 rounded-lg px-1 py-1 transition-colors ${
                    team._isNew ? 'bg-field-bright/5 border border-field-bright/20' :
                ...
                >
                  ...
                  <input
                    ...
                    className="flex-1 min-w-0 px-2 py-1.5 bg-[var(--card-bg)] border border-[var(--card-border)] rounded text-text-primary text-sm focus:outline-none focus:border-accent-gold"
                  />
                  <input
                    type="number"
                    value={team.wins}
                    onChange={e => updateTeam(idx, 'wins', e.target.value)}
                    className="w-14 px-1.5 py-1.5 bg-[var(--card-bg)] border border-[var(--card-border)] rounded text-text-primary text-sm text-center font-mono focus:outline-none focus:border-accent-gold"
                  />
                  <input
                    type="number"
                    value={team.losses}
                  ...
                  <input
                    ...
                    className="w-20 px-1.5 py-1.5 bg-[var(--card-bg)] border border-[var(--card-border)] rounded text-text-primary text-sm text-center font-mono focus:outline-none focus:border-accent-gold"
                  />
                  <input
                    type="number"
                    step="0.1"
                  ...
                  <select
                    ...
                    className="w-28 px-1 py-1.5 bg-[var(--card-bg)] border border-[var(--card-border)] rounded text-text-primary text-xs font-mono focus:outline-none focus:border-accent-gold"
                  >
                  ...
                  <div className="w-6 flex-shrink-0">
                    {team._isNew && (
                      <button
                        ...
                        className="text-live-red hover:text-red-300 text-sm"
                        title="Remove"
                      >
                        &times;
                      </button>
          ...
          <button
            onClick={addTeam}
            className="mt-3 w-full py-2 border border-dashed border-[var(--card-border)] rounded-lg text-text-secondary text-sm hover:border-accent-gold/50 hover:text-accent-gold transition-colors"
          >
            + Add Team
          </button>
        </div>
