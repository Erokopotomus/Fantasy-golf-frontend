...
const TIER_STYLES = {
  ...
  DEVELOPING: { bg: 'bg-white/10', text: 'text-white/60', border: 'border-white/20' },
  ROOKIE:     { bg: 'bg-white/5', text: 'text-white/40', border: 'border-white/10' },
  UNRANKED:   { bg: 'bg-white/5', text: 'text-white/30', border: 'border-white/10' },
}
