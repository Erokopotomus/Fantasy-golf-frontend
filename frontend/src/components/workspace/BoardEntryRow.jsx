...
export default function BoardEntryRow({ entry, index, sport, positionRank, leagueStatus, onRemove, onClickNotes, onUpdateTags, onClickPlayer, onUpdateAuctionValue, isNewlyAdded, compareMode, isCompareSelected, onToggleCompare }) {
  const {
    attributes,
    listeners,
    setNodeRef,
