...
export default function PlayerNoteEditor({ entry, onSave, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" onClick={onClose}>
      ...
      <div
        className="relative w-full max-w-sm bg-dark-secondary border border-white/[0.08] rounded-xl shadow-2xl"
      ...
      >
        ...
        <div className="flex items-center gap-3 px-4 py-3 border-b border-white/[0.06]">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="text-[11px] text-white/40">Rank #{entry.rank}</div>
          </div>
        ...
        <div className="p-4">
          <textarea
            ...
            rows={4}
            className="w-full bg-dark-primary border border-white/[0.08] rounded-lg p-3 text-sm text-white placeholder-white/30 outline-none focus:border-gold/50 resize-none"
          />
        </div>
        ...
        <div className="flex justify-end gap-2 px-4 pb-4">
          ...
          <button
            onClick={handleSave}
            className="px-4 py-1.5 text-xs font-semibold bg-gold text-dark-primary rounded-lg hover:bg-gold/90 transition-colors"
          >
            Save
          </button>
        </div>
