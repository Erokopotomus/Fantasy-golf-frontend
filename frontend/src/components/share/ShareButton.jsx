...
export default function ShareButton({ CardComponent, cardProps, label = 'Share' }) {
  ...
  return (
    <div className="relative inline-block" ref={menuRef}>
      ...
      {/* Dropdown menu */}
      {showMenu && (
        <div className="absolute right-0 top-full mt-1 bg-[#1A1510] border border-[var(--card-border)] rounded-lg shadow-2xl py-1 z-50 min-w-[160px]">
          <button
            onClick={handleDownload}
            className="w-full text-left px-3 py-2 text-sm text-text-primary/80 hover:bg-[var(--surface-alt)] flex items-center gap-2"
          >
